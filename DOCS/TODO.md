...
## Priority 0.1.1: Badge from Star Behavioral Health Providers — DONE

a badge from star behavioral health providers stating train provider military focused care, you can put it on the website.

Shipped: `assets/img/SBHP-Web-Badge-Provider.png` renders in the shared footer
on all 17 pages, labelled "Trained Provider for Military-Focused Care". The
boxes below were never ticked, which is the only reason this still read as open.
