...
export const FAQ = Object.freeze({
  "/": [
    ...
    { q: "Do you accept insurance?", a: "Yes. Cascade Health Alliance (CHA), Oregon Health Plan (OHP), Atrio, Aetna, Moda, Providence, Regence, Cigna, TriWest, and Evernorth are accepted, as well as cash, credit cards, and debit cards. If your plan is not listed, ask during the consultation call." },
  ...
  "/about/": [
    ...
    { q: "What insurance plans does Elaine accept?", a: "Elaine accepts Cascade Health Alliance (CHA), Oregon Health Plan (OHP), Atrio, Aetna, Moda, Providence, Regence, Cigna, TriWest, and Evernorth. She also works with military insurance (TRICARE) and can help you navigate veterans&#8217; benefits. Please contact us to verify your specific insurance coverage." },
